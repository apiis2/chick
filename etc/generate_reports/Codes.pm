  ...
  foreach my $adr ( @{$data} ) {
    ...
    if ( $oldunit ne $line[0] ) {
      ...
      $self->{'_longtablecontent'} .= "\\rhead{\\large \\textbf{ $line[0] }}
           \\chead{\\textbf{ \\raisebox{1ex}{".main::__('Codesliste')."} }}
           \\lhead{\\today\\\\".main::__('Seite').": \\thepage}
           \\lfoot{\\tiny }
	   \\cfoot{}\n\n";

      $self->{'_longtablecontent'} .= "\\begin{longtable}{\@{}lll>{\\raggedright}p{52mm}>{\\raggedright}p{54mm}ll\@{}}\\hline\n\n";
      $self->{'_longtablecontent'} .= "{\\textbf{ ".main::__('interner code')."}} & {\\textbf{ ".main::__('externer code')."}} & {\\textbf{ ".main::__('Kurzname')."}} &{\\textbf{ ".main::__('Langer Name')."}} &{\\textbf{ ".main::__('Beschreibung')."}} & ".main::__('von')." & ".main::__('bis')." \\\\  ";
