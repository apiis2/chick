...
<Form Name="FORM_1461240601">
  ...
  <Block Name="B369" Description="Update animal">
    ...
    <DataSource Name="DS370" Connect="no">
      ...
      <Column DBName="ext_unit" Name="C86" Order="1" RelatedColumn="C316" RelatedOrder="0" Type="Related"/>
      <Column DBName="ext_id" Name="C88" Order="2" RelatedColumn="C316" RelatedOrder="1" Type="Related"/>
      <Column DBName="ext_animal" Name="C90" Order="3" RelatedColumn="C316" RelatedOrder="2" Type="Related"/>
      ...
      <Column DBName="db_selection" Name="C339" Order="11" Type="DB"/>
      ...
      <Column DBName="line" Name="C366" Order="20" Type="DB"/>
    </DataSource>
    ...
    <Label Name="L695" Content="__('animal-id'): ">
    ...
    <Field Name="Fanimal_ext_id" DSColumn="C88" FlowOrder="2" >
    ...
    <Label Name="L695a" Content="__('sire-id'): ">
    ...
    <Label Name="L695b" Content="__('dam-id'): ">
    ...
    <Label Name="L343" Content="__('db_sex'): ">
    ...
    <Label Name="L320" Content="__('db_breed'): ">
    ...
    <Label Name="L325" Content="__('db_cage'): ">
    ...
    <Label Name="L353" Content="__('exit_dt'): ">
    ...
    <Label Name="L335" Content="__('db_exit'): ">
    ...
    <Label Name="L365" Content="__('line'): ">
      <Position Column="0" Position="absolute" Row="12"/>
    </Label>

    <Field Name="F367" DSColumn="C366" FlowOrder="17" >
      <TextField Override="no" Size="10"/>
