...
<Form Name="F8">
  <General Name="G177" StyleSheet="/etc/apiis.css" Description="__('Number of eggs incubated')"/>

  <Block Name="DS031" Description="'Number of eggs incubated'">
    <DataSource Name="DataSource_493"  Connect="no">
        <none/>
        <Parameter Name="Parameter1" Key="LO" Value="LO_DS020304"/>
    </DataSource>
		    
    <Label Name="DS032" Content="__('Number of eggs incubated')">
      <Position Column="0" Columnspan="5" Position="absolute" Row="0"/>
      <Text FontSize="24px" TextDecoration="none"/>
      <Format PaddingBottom="10px"/>
    </Label>

    <Label Name="DS033" Content="__('Cage-ID')">
    ...
    <Label Name="DS034" Content="__('Number of eggs incubated')">
      <Position Column="0" Position="absolute" Row="4"/>
    </Label>
    <Field Name="incubated_eggs" FlowOrder="3" Check="NotNull" >
