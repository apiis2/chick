...
<Form Name="F8">
  <General Name="G177" StyleSheet="/etc/apiis.css" Description="__('Number of hatched chicks')"/>

  <Block Name="DS041" Description="'Number of hatched chicks'">
    <DataSource Name="DataSource_493"  Connect="no">
        <none/>
        <Parameter Name="Parameter1" Key="LO" Value="LO_DS020304"/>
    </DataSource>
		    
    <Label Name="DS042" Content="__('Number of hatched chicks')">
      <Position Column="0" Columnspan="5" Position="absolute" Row="0"/>
      <Text FontSize="24px" TextDecoration="none"/>
      <Format PaddingBottom="10px"/>
    </Label>

    <Label Name="DS043" Content="__('Cage-ID')">
    ...
    <Label Name="DS044" Content="__('Number of hatched chicks')">
      <Position Column="0" Position="absolute" Row="4"/>
    </Label>
    <Field Name="hatched_eggs" FlowOrder="3" Check="NotNull" >
 ...
 <Label Name="DS045" Content="__('Hatch Date (dd.mm.yyyy)')">
      <Position Column="0" Position="absolute" Row="5"/>
    </Label>
    <Field Name="hatch_dt" FlowOrder="3" Check="NotNull" >
       <TextField Override="no" Size="2" MaxLength="10"/>  
