...
my @datastreams=('LO_DS020304', 'LO_DS05','LO_DS10','LO_DS06','LO_DS07_1', 'LO_DS07_2', 'LO_DS09', 'LO_DS08_1', 'LO_DS08_2','LO_DS11');
...
sub FileUpload {
    my ( $self, $filename, $importfilter,$onlycheck, $action, $breed, $db_animal,$history ) = @_;
    my @bak;
    my $json;
    my @data;    
    my $pack;
